...
public class LineFollower {
    ...
    public static int[] motorsSpeed(int R, int G, int B){
        ...
        if (sensorValue <= 18){
//            System.out.println("WARNING 1: Sample[0]=" +  sensorValue);
            speeds[0] = 200;
            speeds[1] = 0;
        }
...
//            System.out.println("WARNING 3: To the infinity and beyond   =" +  sensorValue);
            speeds[0] = 200;
            speeds[1] = 200;
        }
...
//            System.out.println("WARNING 2: Sample[0]=" +  sensorValue);
//            speeds[0] = 0;
//            speeds[1] = 0;
////        }
